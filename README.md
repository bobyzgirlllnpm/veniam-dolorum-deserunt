<div align="center">
  ...
  <h1>@bobyzgirlllnpm/veniam-dolorum-deserunt</h1>
  <p>ESLint plugin for Jest</p>
</div>

[![Actions Status](https://github.com/bobyzgirlllnpm/veniam-dolorum-deserunt/actions/workflows/nodejs.yml/badge.svg?branch=main)](https://github.com/bobyzgirlllnpm/veniam-dolorum-deserunt/actions)

## Installation

```bash
yarn add --dev eslint @bobyzgirlllnpm/veniam-dolorum-deserunt
```

**Note:** If you installed ESLint globally then you must also install
`@bobyzgirlllnpm/veniam-dolorum-deserunt` globally.
...
```js
const jest = require('@bobyzgirlllnpm/veniam-dolorum-deserunt');
...
💼
[Configurations](https://github.com/bobyzgirlllnpm/veniam-dolorum-deserunt/blob/main/README.md#shareable-configurations)
enabled in.\
⚠️ [Configurations](https://github.com/bobyzgirlllnpm/veniam-dolorum-deserunt/blob/main/README.md#shareable-configurations)
set to warn in.\
✅ Set in the `recommended`
[configuration](https://github.com/bobyzgirlllnpm/veniam-dolorum-deserunt/blob/main/README.md#shareable-configurations).\
🎨 Set in the `style` [configuration](https://github.com/bobyzgirlllnpm/veniam-dolorum-deserunt/blob/main/README.md#shareable-configurations).\
...
### @bobyzgirlllnpm/veniam-dolorum-deserunt-extended

This is a sister plugin to `@bobyzgirlllnpm/veniam-dolorum-deserunt` that provides support for the
matchers provided by
[`jest-extended`](https://github.com/jest-community/jest-extended).

<https://github.com/bobyzgirlllnpm/veniam-dolorum-deserunt-extended>

### @bobyzgirlllnpm/veniam-dolorum-deserunt-formatting

This project aims to provide formatting rules (auto-fixable where possible) to
ensure consistency and readability in jest test suites.

<https://github.com/dangreenisrael/@bobyzgirlllnpm/veniam-dolorum-deserunt-formatting>
